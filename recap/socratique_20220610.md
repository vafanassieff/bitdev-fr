...
- bloque inutilement des HTCLs pendant certaines durées, ce qui peut bloquer complètement un canal quand le nombre maximal de HTLCs simultanés (une dizaine en pratique) est atteint,
- **TODO: quelque chose d'autre évoqué ? Il me semble que oui.**
